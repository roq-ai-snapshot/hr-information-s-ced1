  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of efficient management with HR Information System - Your ultimate solution for employee data, vacations, and payroll management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of efficient management with HR Information System - Your ultimate solution for employee data, vacations, and payroll management.`}
            </Text>
            <Box
